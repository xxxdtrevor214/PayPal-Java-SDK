 ...
 */
public class InvoiceListRequest extends HttpRequest<InvoiceList> {

    public InvoiceListRequest() {
        super("/v1/invoicing/invoices/?", "GET", InvoiceList.class);
        
        header("Content-Type", "application/json");
    }

    public InvoiceListRequest page(Integer page) {
    ...
    public InvoiceListRequest pageSize(Integer pageSize) {
    ...
    public InvoiceListRequest totalCountRequired(Boolean totalCountRequired) {
        String params = String.valueOf(totalCountRequired);
        try {
		    path(path() + "total_count_required=" + URLEncoder.encode(params, "UTF-8") + "&");
        } catch (UnsupportedEncodingException ignored) {}
        return this;
    }
