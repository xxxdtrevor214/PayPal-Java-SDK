 ...
 */
public class CreditCardUpdateRequest extends HttpRequest<CreditCard> {

    public CreditCardUpdateRequest(String creditCardId) {
        super("/v1/vault/credit-cards/{credit_card_id}?", "PATCH", CreditCard.class);
        try {
