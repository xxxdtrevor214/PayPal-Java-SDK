 ...
 */
public class WebhookListRequest extends HttpRequest<WebhookList> {
    ...
    public WebhookListRequest anchorType(String anchorType) {
        String params = String.valueOf(anchorType);
        try {
		    path(path() + "anchor_type=" + URLEncoder.encode(params, "UTF-8") + "&");
