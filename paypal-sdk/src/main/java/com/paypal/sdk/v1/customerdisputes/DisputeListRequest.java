 ...
 */
public class DisputeListRequest extends HttpRequest<DisputeSearchResponse> {

    public DisputeListRequest() {
        super("/v1/customer/disputes?", "GET", DisputeSearchResponse.class);
        
        header("Content-Type", "application/json");
    }

    public DisputeListRequest disputeState(String disputeState) {
        String params = String.valueOf(disputeState);
        try {
		    path(path() + "dispute_state=" + URLEncoder.encode(params, "UTF-8") + "&");
        } catch (UnsupportedEncodingException ignored) {}
        return this;
    }

    public DisputeListRequest disputedTransactionId(String disputedTransactionId) {
        String params = String.valueOf(disputedTransactionId);
        try {
		    path(path() + "disputed_transaction_id=" + URLEncoder.encode(params, "UTF-8") + "&");
        } catch (UnsupportedEncodingException ignored) {}
        return this;
    }

    public DisputeListRequest nextPageToken(String nextPageToken) {
        String params = String.valueOf(nextPageToken);
        try {
		    path(path() + "next_page_token=" + URLEncoder.encode(params, "UTF-8") + "&");
        } catch (UnsupportedEncodingException ignored) {}
        return this;
    }

    public DisputeListRequest pageSize(Integer pageSize) {
    ...
    public DisputeListRequest totalRequired(Boolean totalRequired) {
