 ...
 */
public class WebProfileListRequest extends HttpRequest<WebProfileList> {

    public WebProfileListRequest() {
        super("/v1/payment-experience/web-profiles/?", "GET", WebProfileList.class);
