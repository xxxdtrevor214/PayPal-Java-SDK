...
// AgreementTransactionsRequest.java
 ...
 */
public class AgreementTransactionsRequest extends HttpRequest<AgreementTransactions> {

    public AgreementTransactionsRequest(String agreementId) {
        super("/v1/payments/billing-agreements/{agreement_id}/transactions?", "GET", AgreementTransactions.class);
        try {
