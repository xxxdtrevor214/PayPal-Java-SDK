...
// DisputeProvideEvidenceRequest.java
 ...
 */
public class DisputeProvideEvidenceRequest extends HttpRequest<SubsequentActions> {

    public DisputeProvideEvidenceRequest(String disputeId) {
        super("/v1/customer/disputes/{dispute_id}/provide-evidence?", "POST", SubsequentActions.class);
        try {
            path(path().replace("{dispute_id}", URLEncoder.encode(String.valueOf(disputeId), "UTF-8")));
