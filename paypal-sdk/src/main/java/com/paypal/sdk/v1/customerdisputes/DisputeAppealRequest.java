 ...
 */
public class DisputeAppealRequest extends HttpRequest<SubsequentActions> {

    public DisputeAppealRequest(String disputeId) {
        super("/v1/customer/disputes/{dispute_id}/appeal?", "POST", SubsequentActions.class);
        try {
