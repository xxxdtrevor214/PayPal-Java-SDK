 ...
 */
public class Transaction implements Serializable, Deserializable {
	...
	*/
    ...
    public void serialize(Map<String, Object> serialized) {
        ...
        if (relatedResources != null) {
            serialized.put("related_resources", this.relatedResources);
        }
    ...
    public void deserialize(Map<String, Object> values) {
        ...
        if (values.containsKey("related_resources")) {
            this.relatedResources = new ArrayList<>();
				List<Map<String, Object>> nestedValues = (List<Map<String, Object>>) values.get("related_resources");
				for (Map<String, Object> nestedValue : nestedValues) {
					RelatedResources nested = new RelatedResources();
					nested.deserialize(nestedValue);
					this.relatedResources.add(nested);
                }
        }
