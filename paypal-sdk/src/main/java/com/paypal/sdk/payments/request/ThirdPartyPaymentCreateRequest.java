 ...
 */
public class ThirdPartyPaymentCreateRequest extends HttpRequest<Payment> {

    public ThirdPartyPaymentCreateRequest(String accessToken) {
    ...
    public ThirdPartyPaymentCreateRequest requestBody(Payment body) {
