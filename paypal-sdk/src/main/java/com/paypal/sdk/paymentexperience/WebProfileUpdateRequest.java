 ...
 */
public class WebProfileUpdateRequest extends HttpRequest<Void> {

    public WebProfileUpdateRequest(String profileId) {
        super("/v1/payment-experience/web-profiles/{profile_id}?", "PUT", Void.class);
        try {
