 ...
 */
public class WebProfileGetRequest extends HttpRequest<WebProfile> {

    public WebProfileGetRequest(String profileId) {
        super("/v1/payment-experience/web-profiles/{profile_id}?", "GET", WebProfile.class);
        try {
