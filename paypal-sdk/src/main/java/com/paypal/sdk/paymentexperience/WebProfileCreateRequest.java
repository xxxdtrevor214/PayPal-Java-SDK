 ...
 */
public class WebProfileCreateRequest extends HttpRequest<WebProfile> {

    public WebProfileCreateRequest() {
        super("/v1/payment-experience/web-profiles/?", "POST", WebProfile.class);
