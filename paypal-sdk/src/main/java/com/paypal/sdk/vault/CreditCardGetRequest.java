 ...
 */
public class CreditCardGetRequest extends HttpRequest<CreditCard> {

    public CreditCardGetRequest(String creditCardId) {
        super("/v1/vault/credit-cards/{credit_card_id}?", "GET", CreditCard.class);
        try {
