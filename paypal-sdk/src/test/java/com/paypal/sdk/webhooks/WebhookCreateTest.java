...
import static com.paypal.sdk.webhooks.WebhookDeleteTest.deleteWebhook;
import static com.paypal.sdk.webhooks.WebhookListTest.listAllWebhooks;
...
public class WebhookCreateTest extends TestHarness {
    ...
    private static Webhook buildRequestBody() {
        String url = String.format("https://example.com/%s", Math.abs(new Random().nextInt()));
