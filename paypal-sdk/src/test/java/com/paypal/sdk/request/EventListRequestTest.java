...
public class EventListRequestTest extends TestHarness {

    @Test
    public void testEventListRequest() throws IOException {
        EventListRequest request = new EventListRequest();

        HttpResponse<EventList> response = client().execute(request);
